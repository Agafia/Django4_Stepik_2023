...
CACHES = {
    "default": {
        "BACKEND": "django.core.cache.backends.dummy.DummyCache", # заглушка для отключения кэширования
...
EMAIL_PORT = 465
EMAIL_HOST_USER = "surgutfire@yandex.ru"
EMAIL_HOST_PASSWORD = "cifewipgvnwlqvci"
EMAIL_USE_SSL = True
